    ...
    <svg viewBox="0 0 500 820" version="1.1" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
      ...
      <defs>
        <linearGradient x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse"
          ...
          <stop offset="0" stop-color="${color || "rgb(18,111,198)"}"/>
          <stop offset="1" stop-color="${color || "rgb(76,156,209)"}"/>
        </linearGradient>
        <linearGradient x1="0" y1="0" x2="1" y2="0"
                        gradientUnits="userSpaceOnUse"
                        gradientTransform="matrix(1.16666e-15,-19.053,19.053,1.16666e-15,414.482,522.486)"
                        id="map-marker-38-s">
          <stop offset="0" stop-color="${color || "rgb(46,108,151)"}"/>
          <stop offset="1" stop-color="${color || "rgb(56,131,183)"}"/>
        </linearGradient>
      </defs>
